	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            _reactMgr.ReactMgr,
	            {
	              id: 'colors',
	              size: carouselSizeH,
	              orientation: _reactMgr.Orientation.Horizontal,
	              onPageChanged: function onPageChanged(page) {
	                _this2.setState({ mgr1: page });
	              },
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            _reactMgr.ReactMgr,
	            {
	              id: 'colors',
	              size: carouselSizeV,
	              orientation: _reactMgr.Orientation.Vertiacal,
	              onPageChanged: function onPageChanged(page) {
	                _this2.setState({ mgr4: page });
	              },
